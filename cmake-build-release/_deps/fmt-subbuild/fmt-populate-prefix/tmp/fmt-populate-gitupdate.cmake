...
execute_process(
  COMMAND "/usr/bin/git" show-ref "6.1.2"
  WORKING_DIRECTORY "/home/wyz/cad420/voxer/cmake-build-release/_deps/fmt-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/6.1.2")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "6.1.2")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/fmt-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/fmt-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
