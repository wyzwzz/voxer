...
execute_process(
  COMMAND "/usr/bin/git" show-ref "2f7a1ebf1b1dcc59d5d2f54c39e291def47b5064"
  WORKING_DIRECTORY "/home/wyz/cad420/voxer/cmake-build-release/_deps/cimg-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/2f7a1ebf1b1dcc59d5d2f54c39e291def47b5064")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "2f7a1ebf1b1dcc59d5d2f54c39e291def47b5064")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "2f7a1ebf1b1dcc59d5d2f54c39e291def47b5064")
endif()
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/dtschump/CImg.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/cimg-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/cimg-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
