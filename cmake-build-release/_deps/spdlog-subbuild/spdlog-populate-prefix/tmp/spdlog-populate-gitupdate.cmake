...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.8.1"
  WORKING_DIRECTORY "/home/wyz/cad420/voxer/cmake-build-release/_deps/spdlog-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.8.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.8.1")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/spdlog-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/spdlog-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
