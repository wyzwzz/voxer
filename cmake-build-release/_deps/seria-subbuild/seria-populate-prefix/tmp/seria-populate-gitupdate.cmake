...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v0.1"
  WORKING_DIRECTORY "/home/wyz/cad420/voxer/cmake-build-release/_deps/seria-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v0.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v0.1")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/ukabuer/seria.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/seria-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/wyz/cad420/voxer/cmake-build-release/_deps/seria-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
